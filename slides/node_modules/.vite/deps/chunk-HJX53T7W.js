...
var SequenceManagerProvider = ({ children }) => {
  ...
  return (0, import_jsx_runtime10.jsx)(SequenceManagerRefContext.Provider, {
    value: sequencesRef,
    children: (0, import_jsx_runtime10.jsx)(SequenceManager.Provider, {
      value: sequenceContext,
      children: (0, import_jsx_runtime10.jsx)(VisualModePropStatusesRefContext.Provider, {
        value: propStatusesRef,
        children: (0, import_jsx_runtime10.jsx)(VisualModePropStatusesContext.Provider, {
          value: propStatusesContext,
          children: (0, import_jsx_runtime10.jsx)(VisualModeDragOverridesContext.Provider, {
            value: dragOverridesContext,
            children: (0, import_jsx_runtime10.jsx)(VisualModeSettersContext.Provider, {
...
var IsInsideSeriesContainer = ({ children }) => {
  return (0, import_jsx_runtime11.jsx)(IsInsideSeriesContext.Provider, {
    value: true,
    children
  });
};
...
var parseStringInterpolationValue = (output) => {
  ...
  if (kind === "scale") {
    ...
    const y = ((_a = parsed[1]) == null ? void 0 : _a.value) ?? x;
    const z = ((_b = parsed[2]) == null ? void 0 : _b.value) ?? 1;
    return {
      kind,
      values: [x, y, z],
      units: [null, null, null],
  ...
  return {
    kind,
    values: [parsed[0].value, ((_c = parsed[1]) == null ? void 0 : _c.value) ?? 0, ((_d = parsed[2]) == null ? void 0 : _d.value) ?? 0],
    units: [parsed[0].unit, ((_e = parsed[1]) == null ? void 0 : _e.unit) ?? null, ((_f = parsed[2]) == null ? void 0 : _f.unit) ?? null],
    dimensions: parsed.length
  };
};
...
var OverrideIdsToNodePathsGettersContext = (0, import_react32.createContext)({
  overrideIdToNodePathMappings: {}
});
var OverrideIdsToNodePathsSettersContext = (0, import_react32.createContext)({
...
var useMemoizedEffectDefinitions = (effects) => {
  const previousRef = (0, import_react31.useRef)(null);
...
var useMemoizedEffects = ({
  ...
  const previousRef = (0, import_react31.useRef)(null);
  const { propStatuses } = (0, import_react31.useContext)(VisualModePropStatusesContext);
  const { getEffectDragOverrides } = (0, import_react31.useContext)(VisualModeDragOverridesContext);
  const frame = useCurrentFrame();
  const { overrideIdToNodePathMappings } = (0, import_react31.useContext)(OverrideIdsToNodePathsGettersContext);
  const previous = previousRef.current;
...
var withInteractivitySchema = ({
  ...
  const Wrapped = (0, import_react30.forwardRef)((props, ref) => {
    const env = useRemotionEnvironment();
    ...
    const { propStatuses } = (0, import_react30.useContext)(VisualModePropStatusesContext);
    const { getDragOverrides } = (0, import_react30.useContext)(VisualModeDragOverridesContext);
    const nodePathMapping = (0, import_react30.useContext)(OverrideIdsToNodePathsGettersContext);
    const frame = useCurrentFrame();
    if (props.controls) {
      return import_react30.default.createElement(Component, {
        ...props,
    ...
    const [overrideId] = (0, import_react30.useState)(() => {
      const { stack } = props;
      if (!stack) {
    ...
    const currentRuntimeValueDotNotation = (0, import_react30.useMemo)(() => readValuesFromProps(props, flatKeys), runtimeValues);
    const controls = (0, import_react30.useMemo)(() => {
      return {
    ...
    const { merged: valuesDotNotation, propsToDelete } = (0, import_react30.useMemo)(() => {
...
var RegularSequenceRefForwardingFunction = ({
  ...
  const wrapperRefForOutline = (0, import_react19.useRef)(null);
  ...
  const env = useRemotionEnvironment();
  const isInsideSeries = (0, import_react19.useContext)(IsInsideSeriesContext);
  ...
  const frozenContent = content === null || typeof freeze === "undefined" || freeze === null ? content : (0, import_jsx_runtime12.jsx)(Freeze, {
    frame: freeze,
    children: content
  });
  const styleIfThere = other.layout === "none" ? void 0 : other.style;
  const sequenceRef = (0, import_react19.useCallback)((node) => {
  ...
  return (0, import_jsx_runtime12.jsx)(SequenceContext.Provider, {
    value: contextValue,
    children: frozenContent === null ? null : other.layout === "none" ? frozenContent : (0, import_jsx_runtime12.jsx)(AbsoluteFill, {
      ref: sequenceRef,
      style: defaultStyle,
      className: other.className,
...
var useEffectChainState = () => {
  const chainStateRef = (0, import_react35.useRef)(null);
  const sizeRef = (0, import_react35.useRef)(null);
...
var CanvasRefForwardingFunction = ({ width, height, fit, className, style, effects }, ref) => {
  ...
  const sourceCanvas = (0, import_react34.useMemo)(() => {
    if (typeof document === "undefined") {
      return null;
    }
...
var AnimatedImageContent = (0, import_react33.forwardRef)(({
  src,
  width,
  height,
  onError,
  ...
  const requestInitRef = (0, import_react33.useRef)(requestInit);
...
var AnimatedImageInner = ({
  ...
  const actualRef = (0, import_react33.useRef)(null);
  ...
  return (0, import_jsx_runtime14.jsx)(Sequence, {
    layout: "none",
    ...
    children: (0, import_jsx_runtime14.jsx)(AnimatedImageContent, {
      ...animatedImageProps,
      ref: actualRef,
      effects,
      controls
...
var RenderAssetManagerProvider = ({ children, collectAssets }) => {
  ...
  return (0, import_jsx_runtime15.jsx)(RenderAssetManager.Provider, {
    value: contextValue,
    children
  });
};
...
var Loop = ({
  ...
  return (0, import_jsx_runtime16.jsx)(LoopContext.Provider, {
    value: loopContext,
    children: (0, import_jsx_runtime16.jsx)(Sequence, {
      durationInFrames,
      from,
      name: name ?? "<Loop>",
...
var PrefetchProvider = ({ children }) => {
  ...
  return (0, import_jsx_runtime17.jsx)(PreloadContext.Provider, {
    value: _preloads,
    children
  });
};
  ...
  return {
    free: () => {
      ...
      if (objectUrl) {
        ...
        reader == null ? void 0 : reader.cancel(cancellationError).catch(() => {
          return;
        });
      }
    },
...
var DurationsContextProvider = ({ children }) => {
  ...
  return (0, import_jsx_runtime18.jsx)(DurationsContext.Provider, {
    value,
    children
  });
};
...
var useSingletonAudioContext = ({
  ...
  const env = useRemotionEnvironment();
  const initialSampleRate = (0, import_react47.useRef)(sampleRate);
...
var SharedAudioContextProvider = ({ children, audioLatencyHint, audioEnabled, previewSampleRate }) => {
  ...
  return (0, import_jsx_runtime19.jsx)(SharedAudioContext.Provider, {
...
var SharedAudioTagsContextProvider = ({ children, numberOfAudioTags }) => {
  ...
  return (0, import_jsx_runtime19.jsxs)(SharedAudioTagsContext.Provider, {
...
var BufferingProvider = ({ children }) => {
  ...
  return (0, import_jsx_runtime20.jsx)(BufferingContextReact.Provider, {
    value: bufferManager,
    children
  });
};
...
var usePlayerMutedState = () => {
  const { playerMuted } = (0, import_react59.useContext)(MediaVolumeContext);
  const { setPlayerMuted } = (0, import_react59.useContext)(SetMediaVolumeContext);
  return (0, import_react59.useMemo)(() => {
...
var AudioForDevelopmentForwardRefFunction = (props, ref) => {
  ...
  const getStack = (0, import_react43.useCallback)(() => {
  ...
  return (0, import_jsx_runtime21.jsx)("audio", {
    ref: audioRef,
    preload: "metadata",
    crossOrigin: crossOriginValue,
    ...propsToPass
...
var AudioRefForwardingFunction = (props, ref) => {
  ...
  if (loop && durationFetched !== void 0) {
    if (!Number.isFinite(durationFetched)) {
      return (0, import_jsx_runtime23.jsx)(Html5Audio, {
        ...propsOtherThanLoop,
        ref,
    ...
    return (0, import_jsx_runtime23.jsx)(Loop, {
      layout: "none",
      ...
      children: (0, import_jsx_runtime23.jsx)(Html5Audio, {
        ...propsOtherThanLoop,
        ref,
        _remotionInternalNativeLoopPassed: true
      })
  ...
  if (typeof trimBeforeValue !== "undefined" || typeof trimAfterValue !== "undefined") {
    return (0, import_jsx_runtime23.jsx)(Sequence, {
      layout: "none",
  ...
  if (environment.isRendering) {
    return (0, import_jsx_runtime23.jsx)(AudioForRendering, {
      onDuration,
      ...props,
      ref,
  ...
  return (0, import_jsx_runtime23.jsx)(AudioForPreview, {
...
var SolidInner = ({
  ...
  const [outputCanvas, setOutputCanvas] = (0, import_react61.useState)(null);
  const memoizedEffects = useMemoizedEffects({
    effects,
    overrideId: overrideId ?? null
  });
  const sourceCanvas = (0, import_react61.useMemo)(() => {
    if (typeof document === "undefined") {
      return null;
    }
    const canvas = document.createElement("canvas");
  ...
  const chainState = useEffectChainState();
  const canvasRef = (0, import_react61.useCallback)((canvas) => {
  ...
  const canvasStyle = (0, import_react61.useMemo)(() => {
    return {
      width,
      height,
      ...style ?? {}
  ...
  return (0, import_jsx_runtime24.jsx)("canvas", {
    ref: canvasRef,
    width: canvasWidth,
    height: canvasHeight,
    className,
...
var SolidOuter = (0, import_react61.forwardRef)(({
  effects = [],
  controls,
  color,
  height,
  ...
  const memoizedEffectDefinitions = useMemoizedEffectDefinitions(effects);
  const actualRef = (0, import_react61.useRef)(null);
  ...
  return (0, import_jsx_runtime24.jsx)(Sequence, {
    ...
    ...props2,
    children: (0, import_jsx_runtime24.jsx)(SolidInner, {
      reference: actualRef,
      overrideId: (controls == null ? void 0 : controls.overrideId) ?? null,
      color,
      height,
...
var HtmlInCanvasAncestorContext = (0, import_react62.createContext)(false);
var HtmlInCanvasContent = (0, import_react62.forwardRef)(({
  width,
  height,
  effects,
  children,
  ...
  const isInsideAncestorHtmlInCanvas = (0, import_react62.useContext)(HtmlInCanvasAncestorContext);
  ...
  const canvas2dRef = (0, import_react62.useRef)(null);
  const offscreenRef = (0, import_react62.useRef)(null);
  const divRef = (0, import_react62.useRef)(null);
  const canvasSizeKey = `${width}x${height}@${resolvedPixelDensity}`;
  const setLayoutCanvasRef = (0, import_react62.useCallback)((node) => {
  ...
  const effectsRef = (0, import_react62.useRef)(memoizedEffects);
  effectsRef.current = memoizedEffects;
  const onPaintRef = (0, import_react62.useRef)(onPaint);
  onPaintRef.current = onPaint;
  const onInitRef = (0, import_react62.useRef)(onInit);
  onInitRef.current = onInit;
  const initializedRef = (0, import_react62.useRef)(false);
  const onInitCleanupRef = (0, import_react62.useRef)(null);
  const unmountedRef = (0, import_react62.useRef)(false);
  const onPaintCb = (0, import_react62.useCallback)(async () => {
    ...
    try {
      ...
      if (!initializedRef.current) {
        ...
        try {
          ...
          } else if (isMissingPaintRecordError(error2)) {
  ...
  const onPaintChangedRef = (0, import_react62.useRef)(false);
  (0, import_react62.useLayoutEffect)(() => {
    var _a;
  ...
  const innerStyle = (0, import_react62.useMemo)(() => {
    return {
      width,
      height
    };
  }, [width, height]);
  const canvasStyle = (0, import_react62.useMemo)(() => {
    return {
      width,
      height,
      ...style ?? {}
  ...
  return (0, import_jsx_runtime25.jsx)(HtmlInCanvasAncestorContext.Provider, {
    value: true,
    children: (0, import_jsx_runtime25.jsx)("canvas", {
...
var HtmlInCanvasInner = (0, import_react62.forwardRef)(({
  width,
  height,
  effects = [],
  children,
  ...
  const resolvedDuration = durationInFrames ?? videoDuration;
  const memoizedEffectDefinitions = useMemoizedEffectDefinitions(effects);
  const actualRef = (0, import_react62.useRef)(null);
  const setCanvasRef = (0, import_react62.useCallback)((node) => {
  ...
  return (0, import_jsx_runtime25.jsx)(Sequence, {
    durationInFrames: resolvedDuration,
    ...
    layout: "none",
    ...sequenceProps,
    children: (0, import_jsx_runtime25.jsx)(HtmlInCanvasContent, {
      ref: setCanvasRef,
      width,
      height,
      effects,
...
var CanvasImageContent = (0, import_react63.forwardRef)(({
  src,
  width,
  height,
  fit = "fill",
  ...
  const { delayRender: delayRender2, continueRender: continueRender2, cancelRender: cancelRender2 } = useDelayRender();
  const { delayPlayback } = useBufferState();
  const [outputCanvas, setOutputCanvas] = (0, import_react63.useState)(null);
  const [loadedImage, setLoadedImage] = (0, import_react63.useState)(null);
  ...
  const sourceCanvas = (0, import_react63.useMemo)(() => {
    if (typeof document === "undefined") {
      return null;
    }
    return document.createElement("canvas");
  }, []);
  const canvasRef = (0, import_react63.useCallback)((canvas) => {
    setOutputCanvas(canvas);
    if (refForOutline) {
  ...
  (0, import_react63.useEffect)(() => {
    ...
    onError,
    pauseWhenLoading,
    sequenceContext == null ? void 0 : sequenceContext.postmounting,
    sequenceContext == null ? void 0 : sequenceContext.premounting
  ]);
  (0, import_react63.useEffect)(() => {
  ...
  return (0, import_jsx_runtime26.jsx)("canvas", {
    ...canvasProps,
    ref: canvasRef,
    width,
    height,
...
var CanvasImageInner = (0, import_react63.forwardRef)(({
  src,
  width,
  height,
  fit,
  ...
  const memoizedEffectDefinitions = useMemoizedEffectDefinitions(effects);
  const actualRef = (0, import_react63.useRef)(null);
  (0, import_react63.useImperativeHandle)(ref, () => {
    return actualRef.current;
  }, []);
  return (0, import_jsx_runtime26.jsx)(Sequence, {
    layout: "none",
    from: from ?? 0,
    trimBefore,
    ...
    children: (0, import_jsx_runtime26.jsx)(CanvasImageContent, {
      ref: actualRef,
      src,
      width,
      height,
...
var IFrameRefForwarding = ({
  ...
  return (0, import_jsx_runtime27.jsx)("iframe", {
...
var ImgContent = ({
  ...
  const imageRef = (0, import_react65.useRef)(null);
  const errors = (0, import_react65.useRef)({});
  const { delayPlayback } = useBufferState();
  const sequenceContext = (0, import_react65.useContext)(SequenceContext);
  const _propsValid = true;
  if (!_propsValid) {
    throw new Error("typecheck error");
  }
  const imageCallbackRef = (0, import_react65.useCallback)((img) => {
  ...
  const actualSrc = usePreload(src);
  const retryIn = (0, import_react65.useCallback)((timeout) => {
    if (!imageRef.current) {
      return;
    }
  ...
  const { delayRender: delayRender2, continueRender: continueRender2, cancelRender: cancelRender2 } = useDelayRender();
  const didGetError = (0, import_react65.useCallback)((e) => {
  ...
  return (0, import_jsx_runtime28.jsx)("img", {
    ...props2,
...
var NativeImgInner = ({
  ...
  return (0, import_jsx_runtime28.jsx)(Sequence, {
    ...
    hidden,
    outlineRef: refForOutline,
    children: (0, import_jsx_runtime28.jsx)(ImgContent, {
      src,
      refForOutline,
      ...props2
    })
...
var getFitFromObjectFit = (style) => {
  const objectFit = style == null ? void 0 : style.objectFit;
...
var ImgInner = ({
  ...
  const refForOutline = (0, import_react65.useRef)(null);
  if (effects.length === 0) {
    return (0, import_jsx_runtime28.jsx)(NativeImgInner, {
      ...props2,
      ref,
      hidden,
      name,
  ...
  return (0, import_jsx_runtime28.jsx)(CanvasImageWithPrivateProps, {
    src,
    width: canvasWidth,
    height: canvasHeight,
    fit: canvasFit,
...
var makeInteractiveElement = (tag, displayName) => {
  const Inner = (0, import_react66.forwardRef)((propsWithControls, ref) => {
    const {
      durationInFrames,
      from,
      trimBefore,
    ...
    const refForOutline = (0, import_react66.useRef)(null);
    const callbackRef = (0, import_react66.useCallback)((element) => {
      refForOutline.current = element;
      setRef(ref, element);
    }, [ref]);
    return (0, import_jsx_runtime29.jsx)(Sequence, {
      layout: "none",
      from: from ?? 0,
      trimBefore,
      durationInFrames: durationInFrames ?? Infinity,
      ...
      outlineRef: refForOutline,
      children: import_react66.default.createElement(tag, {
        ...props2,
        ref: callbackRef
      })
    });
...
var compositionsRef = import_react68.default.createRef();
var CompositionManagerProvider = ({
  ...
  const [canvasContent, setCanvasContent] = (0, import_react69.useState)(initialCanvasContent);
  const [compositions, setCompositions] = (0, import_react69.useState)(initialCompositions);
  const currentcompositionsRef = (0, import_react69.useRef)(compositions);
  const updateCompositions = (0, import_react69.useCallback)((updateComps) => {
  ...
  const registerComposition = (0, import_react69.useCallback)((comp) => {
  ...
  const unregisterComposition = (0, import_react69.useCallback)((id) => {
    setCompositions((comps) => {
      return comps.filter((c2) => c2.id !== id);
    });
  }, []);
  const registerFolder = (0, import_react69.useCallback)((name, parent, nonce, stack) => {
  ...
  const unregisterFolder = (0, import_react69.useCallback)((name, parent) => {
    setFolders((prevFolders) => {
      return prevFolders.filter((p) => !(p.name === name && p.parent === parent));
    });
  }, []);
  (0, import_react69.useImperativeHandle)(compositionsRef, () => {
    return {
      getCompositions: () => currentcompositionsRef.current
    };
  }, []);
  const compositionManagerSetters = (0, import_react69.useMemo)(() => {
    return {
      registerComposition,
      unregisterComposition,
      registerFolder,
  ...
  const compositionManagerContextValue = (0, import_react69.useMemo)(() => {
    return {
      compositions,
      folders,
      currentCompositionMetadata,
  ...
  return (0, import_jsx_runtime30.jsx)(CompositionManager.Provider, {
    value: compositionManagerContextValue,
    children: (0, import_jsx_runtime30.jsx)(CompositionSetters.Provider, {
...
var MaxMediaCacheSizeContext = import_react70.default.createContext(null);
var Root = null;
var listeners = [];
...
var MediaEnabledContext = (0, import_react72.createContext)(null);
var useVideoEnabled = () => {
  const context = (0, import_react72.useContext)(MediaEnabledContext);
  if (!context) {
...
var MediaEnabledProvider = ({
  ...
  const value = (0, import_react72.useMemo)(() => ({ videoEnabled, audioEnabled }), [videoEnabled, audioEnabled]);
  return (0, import_jsx_runtime31.jsx)(MediaEnabledContext.Provider, {
    value,
    children
  });
};
var RemotionRootContexts = ({
  ...
  const nonceContext = (0, import_react71.useMemo)(() => {
    let counter = 0;
    return {
      getNonce: () => counter++
    };
  }, []);
  const logging = (0, import_react71.useMemo)(() => {
  ...
  return (0, import_jsx_runtime32.jsx)(LogLevelContext.Provider, {
    ...
    children: (0, import_jsx_runtime32.jsx)(NonceContext.Provider, {
      value: nonceContext,
      children: (0, import_jsx_runtime32.jsx)(TimelineContextProvider, {
        frameState,
        children: (0, import_jsx_runtime32.jsx)(MediaEnabledProvider, {
          videoEnabled,
          audioEnabled,
          children: (0, import_jsx_runtime32.jsx)(EditorPropsProvider, {
            children: (0, import_jsx_runtime32.jsx)(PrefetchProvider, {
              children: (0, import_jsx_runtime32.jsx)(SequenceManagerProvider, {
                children: (0, import_jsx_runtime32.jsx)(DurationsContextProvider, {
                  children: (0, import_jsx_runtime32.jsx)(BufferingProvider, {
                    children: (0, import_jsx_runtime32.jsx)(SharedAudioContextProvider, {
                      audioLatencyHint,
                      audioEnabled,
                      previewSampleRate,
                      children: (0, import_jsx_runtime32.jsx)(SharedAudioTagsContextProvider, {
                        numberOfAudioTags,
                        children
                      })
                    })
...
var SequenceStackTracesUpdateContext = import_react73.default.createContext(() => {
});
var getEnvVariables = () => {
  if (getRemotionEnvironment().isRendering) {
...
var CurrentScaleContext = import_react74.default.createContext(null);
var PreviewSizeContext = (0, import_react74.createContext)({
  setSize: () => {
    return;
  },
...
var useCurrentScale = (options) => {
  const hasContext = import_react74.default.useContext(CurrentScaleContext);
  const zoomContext = import_react74.default.useContext(PreviewSizeContext);
...
var PixelDensityContext = import_react75.default.createContext(null);
...
var usePixelDensity = (options) => {
  const pixelDensity = (0, import_react75.useContext)(PixelDensityContext);
  const canUseRemotionHooks = (0, import_react75.useContext)(CanUseRemotionHooks);
  if (pixelDensity !== null) {
    return pixelDensity;
  }
  if (canUseRemotionHooks || (options == null ? void 0 : options.dontThrowIfOutsideOfRemotion)) {
...
var OffthreadVideoForRendering = ({
  ...
  const videoConfig = useUnsafeVideoConfig();
  const sequenceContext = (0, import_react77.useContext)(SequenceContext);
  const mediaStartsAt = useMediaStartsAt();
  const { registerRenderAsset, unregisterRenderAsset } = (0, import_react77.useContext)(RenderAssetManager);
  if (!src) {
    throw new TypeError("No `src` was passed to <OffthreadVideo>.");
  }
  const id = (0, import_react77.useMemo)(() => `offthreadvideo-${random(src)}-${sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom}-${sequenceContext == null ? void 0 : sequenceContext.relativeFrom}-${sequenceContext == null ? void 0 : sequenceContext.durationInFrames}`, [
    src,
    sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom,
    sequenceContext == null ? void 0 : sequenceContext.relativeFrom,
    sequenceContext == null ? void 0 : sequenceContext.durationInFrames
  ...
  const currentTime = (0, import_react77.useMemo)(() => {
  ...
  const actualSrc = (0, import_react77.useMemo)(() => {
  ...
  const [imageSrc, setImageSrc] = (0, import_react77.useState)(null);
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  ...
  const onErr = (0, import_react77.useCallback)(() => {
    if (onError) {
  ...
  const className = (0, import_react77.useMemo)(() => {
    return [OBJECTFIT_CONTAIN_CLASS_NAME, props2.className].filter(truthy).join(" ");
  }, [props2.className]);
  const onImageFrame = (0, import_react77.useCallback)((img) => {
    if (onVideoFrame) {
      onVideoFrame(img);
    }
  }, [onVideoFrame]);
...
var VideoForDevelopmentRefForwardingFunction = (props2, ref) => {
  const context = (0, import_react78.useContext)(SharedAudioContext);
  if (!context) {
    throw new Error("SharedAudioContext not found");
  }
  const videoRef = (0, import_react78.useRef)(null);
  const sharedSource = (0, import_react78.useMemo)(() => {
  ...
  const effectToUse = import_react78.default.useInsertionEffect ?? import_react78.default.useLayoutEffect;
  effectToUse(() => {
    return () => {
      requestAnimationFrame(() => {
  ...
  const parentSequence = (0, import_react78.useContext)(SequenceContext);
  const logLevel = useLogLevel();
  const mountTime = useMountTime();
  const [timelineId] = (0, import_react78.useState)(() => String(Math.random()));
  ...
  warnAboutTooHighVolume(userPreferredVolume);
  const getStack = (0, import_react78.useCallback)(() => {
    return _remotionInternalStack ?? null;
  }, [_remotionInternalStack]);
  useMediaInTimeline({
    volume,
  ...
  (0, import_react78.useState)(() => playbackLogging({
    logLevel,
  ...
  const currentOnDurationCallback = (0, import_react78.useRef)(onDuration);
  currentOnDurationCallback.current = onDuration;
  ...
  const actualStyle = (0, import_react78.useMemo)(() => {
    return {
      ...style
    };
  }, [style]);
...
var VideoForPreview = (0, import_react78.forwardRef)(VideoForDevelopmentRefForwardingFunction);
var InnerOffthreadVideo = (props2) => {
  ...
  const onDuration = (0, import_react76.useCallback)(() => {
    return;
  }, []);
  ...
  if (typeof trimBeforeValue !== "undefined" || typeof trimAfterValue !== "undefined") {
    return (0, import_jsx_runtime35.jsx)(Sequence, {
      ...
      durationInFrames: trimAfterValue,
      name,
      children: (0, import_jsx_runtime35.jsx)(InnerOffthreadVideo, {
        pauseWhenBuffering: pauseWhenBuffering ?? false,
        ...otherProps,
        trimAfter: void 0,
        name: void 0,
  ...
  if (environment.isRendering) {
    return (0, import_jsx_runtime35.jsx)(OffthreadVideoForRendering, {
      pauseWhenBuffering: pauseWhenBuffering ?? false,
      ...otherProps,
      trimAfter: void 0,
      name: void 0,
  ...
  return (0, import_jsx_runtime35.jsx)(VideoForPreview, {
    _remotionInternalStack: stack ?? null,
    onDuration,
...
var OffthreadVideo = ({
  ...
  return (0, import_jsx_runtime35.jsx)(InnerOffthreadVideo, {
    acceptableTimeShiftInSeconds,
...
function useRemotionContexts() {
  const compositionManagerCtx = import_react80.default.useContext(CompositionManager);
  const timelineContext = import_react80.default.useContext(TimelineContext);
  const setTimelineContext = import_react80.default.useContext(SetTimelineContext);
  const sequenceContext = import_react80.default.useContext(SequenceContext);
  const nonceContext = import_react80.default.useContext(NonceContext);
  const canUseRemotionHooksContext = import_react80.default.useContext(CanUseRemotionHooks);
  const preloadContext = import_react80.default.useContext(PreloadContext);
  const resolveCompositionContext = import_react80.default.useContext(ResolveCompositionContext);
  const renderAssetManagerContext = import_react80.default.useContext(RenderAssetManager);
  const sequenceManagerContext = import_react80.default.useContext(SequenceManager);
  const sequenceManagerRefContext = import_react80.default.useContext(SequenceManagerRefContext);
  const visualModePropStatusesRefContext = import_react80.default.useContext(VisualModePropStatusesRefContext);
  const bufferManagerContext = import_react80.default.useContext(BufferingContextReact);
  const logLevelContext = import_react80.default.useContext(LogLevelContext);
...
var RemotionContextProvider = (props2) => {
  ...
  return (0, import_jsx_runtime36.jsx)(LogLevelContext.Provider, {
    value: contexts.logLevelContext,
    children: (0, import_jsx_runtime36.jsx)(CanUseRemotionHooks.Provider, {
      value: contexts.canUseRemotionHooksContext,
      children: (0, import_jsx_runtime36.jsx)(NonceContext.Provider, {
        value: contexts.nonceContext,
        children: (0, import_jsx_runtime36.jsx)(PreloadContext.Provider, {
          value: contexts.preloadContext,
          children: (0, import_jsx_runtime36.jsx)(CompositionManager.Provider, {
            value: contexts.compositionManagerCtx,
            children: (0, import_jsx_runtime36.jsx)(SequenceManagerRefContext.Provider, {
              value: contexts.sequenceManagerRefContext,
              children: (0, import_jsx_runtime36.jsx)(SequenceManager.Provider, {
                value: contexts.sequenceManagerContext,
                children: (0, import_jsx_runtime36.jsx)(VisualModePropStatusesRefContext.Provider, {
                  value: contexts.visualModePropStatusesRefContext,
                  children: (0, import_jsx_runtime36.jsx)(RenderAssetManager.Provider, {
                    value: contexts.renderAssetManagerContext,
                    children: (0, import_jsx_runtime36.jsx)(ResolveCompositionContext.Provider, {
                      value: contexts.resolveCompositionContext,
                      children: (0, import_jsx_runtime36.jsx)(TimelineContext.Provider, {
                        value: contexts.timelineContext,
                        children: (0, import_jsx_runtime36.jsx)(SetTimelineContext.Provider, {
                          value: contexts.setTimelineContext,
                          children: (0, import_jsx_runtime36.jsx)(SequenceContext.Provider, {
                            value: contexts.sequenceContext,
                            children: (0, import_jsx_runtime36.jsx)(BufferingContextReact.Provider, {
...
var compositionSelectorRef = (0, import_react67.createRef)();
var Internals = {
...
var flattenChildren = (children) => {
  const childrenArray = import_react82.default.Children.toArray(children);
  return childrenArray.reduce((flatChildren, child) => {
    if (child.type === import_react82.default.Fragment) {
...
var SeriesSequenceRefForwardingFunction = ({ children }, _ref) => {
  ...
  return (0, import_jsx_runtime37.jsx)(IsNotInsideSeriesProvider, {
    children
  });
};
var SeriesSequence = (0, import_react81.forwardRef)(SeriesSequenceRefForwardingFunction);
var SequenceWithoutSchemaWithRef = SequenceWithoutSchema;
var SeriesInner = (props2) => {
  const childrenValue = (0, import_react81.useMemo)(() => {
    let startFrame = 0;
    const flattenedChildren = flattenChildren(props2.children);
    return import_react81.Children.map(flattenedChildren, (child, i) => {
      ...
      return (0, import_jsx_runtime37.jsx)(SequenceWithoutSchemaWithRef, {
        ref: castedChild.ref,
  ...
  return (0, import_jsx_runtime37.jsx)(IsInsideSeriesContainer, {
    children: (0, import_jsx_runtime37.jsx)(Sequence, {
      layout: "none",
      name: "<Series>",
...
var Still = (props2) => {
  ...
  return import_react83.default.createElement(Composition, newProps);
};
...
var VideoForRenderingForwardFunction = ({
  ...
  const videoConfig = useUnsafeVideoConfig();
  const videoRef = (0, import_react85.useRef)(null);
  const sequenceContext = (0, import_react85.useContext)(SequenceContext);
  const mediaStartsAt = useMediaStartsAt();
  const environment = useRemotionEnvironment();
  const logLevel = useLogLevel();
  const mountTime = useMountTime();
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  const { registerRenderAsset, unregisterRenderAsset } = (0, import_react85.useContext)(RenderAssetManager);
  const id = (0, import_react85.useMemo)(() => `video-${random(props2.src ?? "")}-${sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom}-${sequenceContext == null ? void 0 : sequenceContext.relativeFrom}-${sequenceContext == null ? void 0 : sequenceContext.durationInFrames}`, [
    props2.src,
    sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom,
    sequenceContext == null ? void 0 : sequenceContext.relativeFrom,
    sequenceContext == null ? void 0 : sequenceContext.durationInFrames
  ...
  return (0, import_jsx_runtime38.jsx)("video", {
    ref: videoRef,
    disableRemotePlayback: true,
    ...props2
  });
};
var VideoForRendering = (0, import_react85.forwardRef)(VideoForRenderingForwardFunction);
var VideoForwardingFunction = (props2, ref) => {
  ...
  const { durations, setDurations } = (0, import_react84.useContext)(DurationsContext);
  ...
  const onDuration = (0, import_react84.useCallback)((src, durationInSeconds) => {
    setDurations({ type: "got-duration", durationInSeconds, src });
  }, [setDurations]);
  ...
  if (loop && durationFetched !== void 0) {
    if (!Number.isFinite(durationFetched)) {
      return (0, import_jsx_runtime39.jsx)(Html5Video, {
        ...propsOtherThanLoop,
        ref,
        stack,
        _remotionInternalNativeLoopPassed: true
    ...
    return (0, import_jsx_runtime39.jsx)(Loop, {
      durationInFrames: calculateMediaDuration({
        trimAfter: trimAfterValue,
      ...
      name,
      showInTimeline: false,
      children: (0, import_jsx_runtime39.jsx)(Html5Video, {
        ...propsOtherThanLoop,
        ref,
        stack,
        _remotionInternalNativeLoopPassed: true
  ...
  if (typeof trimBeforeValue !== "undefined" || typeof trimAfterValue !== "undefined") {
    return (0, import_jsx_runtime39.jsx)(Sequence, {
      layout: "none",
      from: 0 - (trimBeforeValue ?? 0),
      showInTimeline: false,
  ...
  if (environment.isRendering) {
    return (0, import_jsx_runtime39.jsx)(VideoForRendering, {
      onDuration,
      onVideoFrame: onVideoFrame ?? null,
      ...otherProps,
      ref
  ...
  return (0, import_jsx_runtime39.jsx)(VideoForPreview, {
    onlyWarnForMediaSeekingError: false,
    ...otherProps,
    ref,
    onVideoFrame: onVideoFrame ?? null,
...
var Html5Video = (0, import_react84.forwardRef)(VideoForwardingFunction);
...
//# sourceMappingURL=chunk-HJX53T7W.js.map
