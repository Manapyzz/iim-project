...
var PlayIcon = ({ focused }) => {
  return (0, import_jsx_runtime.jsxs)("svg", {
    ...
    fill: "none",
    children: [
      focused ? (0, import_jsx_runtime.jsx)("path", {
        d: playFocusPath,
        fill: "none",
...
var PauseIcon = ({
  ...
  return (0, import_jsx_runtime.jsxs)("svg", {
    ...
    height: ICON_SIZE,
    children: [
      focused ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
        children: [
...
var useBufferStateEmitter = (emitter) => {
  const bufferManager = (0, import_react4.useContext)(Internals.BufferingContextReact);
  if (!bufferManager) {
...
var PlayerEmitterProvider = ({ children, currentPlaybackRate }) => {
  const [emitter] = (0, import_react3.useState)(() => new PlayerEmitter());
...
var usePlayer = () => {
  ...
  }, [config, emitter, setTimelinePosition, video == null ? void 0 : video.id]);
...
var Controls = ({
  ...
  const [playButtonFocused, setPlayButtonFocused] = (0, import_react16.useState)(false);
  ...
  const playPauseButtonStyle = (0, import_react16.useMemo)(() => {
  ...
  const onPlayButtonFocus = (0, import_react16.useCallback)(() => {
    setPlayButtonFocused(true);
  }, []);
  const onPlayButtonBlur = (0, import_react16.useCallback)(() => {
...
var PlayerUI = ({
  ...
  const { playerMuted, mediaVolume } = (0, import_react13.useContext)(Internals.MediaVolumeContext);
  ...
  const { setMediaVolume, setPlayerMuted } = (0, import_react13.useContext)(Internals.SetMediaVolumeContext);
...
var SharedPlayerContexts = ({
  ...
  const [playerMuted, setPlayerMuted] = (0, import_react26.useState)(() => initiallyMuted);
    ...
    children: (0, import_jsx_runtime14.jsx)(Internals.LogLevelContext.Provider, {
      ...
      children: (0, import_jsx_runtime14.jsx)(Internals.CanUseRemotionHooksProvider, {
        children: (0, import_jsx_runtime14.jsx)(Internals.AbsoluteTimeContext.Provider, {
          ...
          children: (0, import_jsx_runtime14.jsx)(Internals.PlaybackRateContext.Provider, {
...
var PlayerFn = ({
  ...
  const playbackRateContextValue = (0, import_react12.useMemo)(() => {
    return {
...
var ThumbnailFn = ({
  ...
  const playbackRateContext = (0, import_react27.useMemo)(() => {
    return {
      playbackRate: 1,
      setPlaybackRate: () => {
